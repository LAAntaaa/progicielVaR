...
/* Bouton réouverture sidebar — toujours visible
   On bloque la transition opacity que Streamlit utilise pour le masquer */
...
/* Streamlit masque via l'état collapsed — on cible aussi cet état */
[data-testid="stSidebarCollapsedControl"]:not(:hover),
[data-testid="stSidebarCollapsedControl"]:hover {
    opacity: 1 !important;
    visibility: visible !important;
}
/* Certaines versions wrappent dans un div avec classe emotion */
