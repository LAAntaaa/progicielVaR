...
/* Uniquement les paragraphes markdown — on ne touche PAS aux labels widgets */
[data-testid="stSidebar"] .stMarkdown p {
    color: #7A8BA8;
    font-size: 11px;
}
/* Radio nav : options bien visibles */
...
/* Bouton collapse intérieur */
[data-testid="stSidebar"] button[kind="headerNoPadding"] {
    color: #7A8BA8 !important;
}
/* ── Bouton réouverture sidebar ── */
/* Forcer le bouton sidebar toujours visible via animation infinie
   Les animations CSS ont priorité sur les transitions inline React */
@keyframes forceVisible {
    from { opacity: 1; visibility: visible; pointer-events: auto; }
    to   { opacity: 1; visibility: visible; pointer-events: auto; }
}
[data-testid="stSidebarCollapsedControl"] {
    animation: forceVisible 1ms linear infinite !important;
    opacity: 1 !important;
    ...
    box-shadow: 3px 0 18px rgba(0,212,255,0.18) !important;
...
[data-testid="stSidebarCollapsedControl"]:hover {
    ...
    box-shadow: 3px 0 28px rgba(0,212,255,0.35) !important;
}
