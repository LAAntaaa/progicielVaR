...
/* ── Bouton réouverture sidebar (toujours visible) ─────────
   Streamlit utilise différents attributs selon la version :
   - data-testid="stSidebarCollapsedControl"  (v1.32+)
   - button[aria-label*="sidebar"]            (fallback)
   ──────────────────────────────────────────────────────── */
...
[data-testid="collapsedControl"] {
    ...
    box-shadow: 3px 0 18px rgba(0,212,255,0.12), inset -1px 0 0 rgba(0,212,255,0.1) !important;
...
[data-testid="collapsedControl"]:hover {
    ...
    box-shadow: 3px 0 24px rgba(0,212,255,0.25) !important;
}
...
/* Bouton fermeture à l'intérieur de la sidebar */
